...
from deus_v3_quickfix.helpers import read_FIX_message, extract_message_field_value
...
class sender():  # fix.Application
    ...
    def send_MarketDataRequest(self, symbol='EURUSD'):
        ...
        reqid = self.app.check_new_symbol(symbol)
        ...
        # header.setField(fix.StringField(167, "?"))
