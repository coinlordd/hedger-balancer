...
from deus_v3_quickfix.application import application


class client():

    def __init__(self, tick_processor,
                 config_file='config/setup.cfg',
    ...
    def isLoggedOnTrade(self):
        true =fix.Session.lookupSession(self.app.sender.sessionID_Trade).isLoggedOn()
